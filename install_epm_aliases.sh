...
epm-help() {
  ...
  printf "│ \033[1;33mКоманда epm\033[0m                   │ \033[1;37mОписание\033[0m                                           │\n"
  printf "├───────────────────────────────┼────────────────────────────────────────────────────┤\n"
  printf "│ \033[1;33mepmu\033[0m                          │ Обновить список доступных пакетов                  │\n"
  ...
  printf "│ \033[1;33mepm ei\033[0m                        │ Обновление самой утилиты epm                       │\n"
  printf "└───────────────────────────────┴────────────────────────────────────────────────────┘\n"
  echo
  ...
  printf "│ \033[1;33mepm play <pkg>\033[0m                │ Установка указанного приложения                    │\n"
